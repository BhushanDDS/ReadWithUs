...
<body>
	<div class="container">
		...
		<form action="php/Suggest.php" method="post" enctype="multipart/form-data" class="shadow p-4 rounded mt-5"  class="form-container"  style="width: 90%; max-width: 50rem; justify-content: center;
  align-items: center;">
        <h1 class="text-center pb-5 display-4 fs-3">
            SuggestUs ReadW!thUs
        </h1>
