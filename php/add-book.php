...
if (isset($_SESSION['user_id']) &&
	...
	if (isset($_POST['book_title'])       &&
		...
		$recommender = $_POST['recomm'];
		$pages	     = $_POST['pages'];

		# making URL data format
		$user_input = 'title='.$title.'&category_id='.$category.'&desc='.$description.'&author_id='.$author.'&recomm='.$recommender.'&pages='.$pages;
        ...
        $location = "../add-book.php";
        $ms = "error";
		is_empty($recommender, $text, $location, $ms, $user_input);

		$text = "pages";
        $location = "../add-book.php";
        $ms = "error";
		is_empty($pages, $text, $location, $ms, $user_input);
		    ...
		    **/
		    if ($file['status'] == "error") {
		        ...
		        **/
			    ...
			    $res  = $stmt->execute([$title, $author, $description, $category, $book_cover_URL, $file_URL,$recommender,$pages]);
