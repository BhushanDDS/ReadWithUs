...
<body>
    ...
    <p class="lead">Hello there! Welcome to your Control Panel. We're glad to have you w!th us.</p>
</div>
...
<table class="table table-bordered shadow">
    <thead>
        <tr>
            ...
            <th>Description</th>
            <th>Category</th>
            <!-- Removed Recommender column if not needed -->
            <th>Actions</th>
        </tr>
    </thead>
    <tbody>
        ...
        ?>
        <tr>
            <td><?=$i + 1?></td> <!-- Increment $i inside the loop -->
            <td>
                <img width="100" src="uploads/cover/<?=$book['cover']?>" alt="Book Cover">
